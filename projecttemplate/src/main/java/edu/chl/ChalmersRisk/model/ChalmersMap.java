...
public class ChalmersMap implements Maps {
    ...
    public ChalmersMap(){
        ...
        continents.add(new Continent("Kemi och Fysik", 3));
        continents.add(new Continent("Kårhuset", 1));
        continents.add(new Continent("SSPA och V-huset", 2));
        continents.add(new Continent("Maskin, EDIT och Hörsalarna", 4));
        ...
        territories.add(new Territory("Fysik", continents.get(1), new Point2D.Double(167.5,140), "fysik.png"));
        territories.add(new Territory("Kemi Matematiska vetenskaper och Biblioteket", continents.get(1), new Point2D.Double(227,43), "kemimattebibliotek.png"));
        territories.add(new Territory("SSPA", continents.get(3), new Point2D.Double(366.5 ,171.5), "sspa.png"));
        territories.add(new Territory("Maskin", continents.get(4), new Point2D.Double(380,100), "maskin.png"));
        territories.add(new Territory("Hörsalarna", continents.get(4), new Point2D.Double(381,72), "horsalarna.png"));
        territories.add(new Territory("EDIT", continents.get(4), new Point2D.Double(488 ,100), "edit.png"));
        territories.add(new Territory("Kopparbunkern", continents.get(4), new Point2D.Double(544 ,77), "kopparbunkern.png"));
        territories.add(new Territory("Väg och vatten", continents.get(3), new Point2D.Double(460 ,198), "VA1.png"));
        territories.add(new Territory("Arkitektur och V & V", continents.get(3), new Point2D.Double(533.5 ,198), "VA2.png"));
        territories.add(new Territory("Kårhuset", continents.get(2), new Point2D.Double(278 ,240), "karhuset.png"));


        for (Territory t: territories) {
            int index = continents.indexOf(t.getContinent());
            continents.get(index).getTerritories().add(t);
        }
